...
public class Matrice implements Serializable {
	...
	public Matrice multiplie(Matrice droite) throws MatriceException {
		
		if(droite == null) {
			throw new IllegalArgumentException("La matrice paramètre ne peut être nulle");
		}
			
		if(colonnes != droite.lignes) {
			throw new MatriceException("Les matrices ne sont pas compatibles");
		}
